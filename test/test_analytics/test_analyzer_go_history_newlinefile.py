...
def az():
    ...
    """
    repo_path = os.path.join(root_path, 'repos/new_line_file')
    script_path = os.path.join(root_path, 'tools/repo_creater/create_repo.py')
    test_src_path = os.path.join(root_path, 'test/go_test_history_repo/new_line_file')
