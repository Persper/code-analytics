...
def az():
    ...
    """
    repo_path = os.path.join(root_path, 'repos/1_1_4_2_no_new_line_between_functions')
    script_path = os.path.join(root_path, 'tools/repo_creater/create_repo.py')
    test_src_path = os.path.join(root_path, 'test/go_test_repos/1_1_4_2_no_new_line_between_functions')
