...
def az():
    ...
    """
    repo_path = os.path.join(root_path, 'repos/1_2_1_1_function_call')
    script_path = os.path.join(root_path, 'tools/repo_creater/create_repo.py')
    test_src_path = os.path.join(root_path, 'test/go_test_repos/1_2_1_1_function_call')
...
async def _test_analzyer_go(az):
    ...
    all_edges = edges_added_by_A.union(edges_added_by_B).union(edges_added_by_C).union(edges_added_by_D).union(edges_added_by_E)
