...
def az():
    ...
    """
    repo_path = os.path.join(root_path, 'repos/go_test_repo_refactor')
    script_path = os.path.join(root_path, 'tools/repo_creater/create_repo.py')
    test_src_path = os.path.join(root_path, 'test/go_test_repo_refactor')
    ...
    try:
        ...
        history_truth = {
            ...
            'C': {'main.go:Vertex:Abs': 1,
                ...
                'main.go::main': 1,
                'main.go::funcB':3},
            'D': {'main.go:Vertex:Abs': 4, ###should have to 1
                'main.go::funcA': 0,
                'main.go::main': 2,
                'main.go:Vertex:Absp': 1 #3
                },
            'E':{
